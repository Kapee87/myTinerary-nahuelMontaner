...
function CityCard({ cityArray }) {
    ...
    return (
        <Link
            ...
            <figure className='w-full h-full overflow-hidden'><img src={image} alt={detail} className='w-full h-full group-hover:scale-125 transition-all duration-1000' /></figure>
